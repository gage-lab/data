...
rule wgs_reads:
    ...
    params:
        ...
        subsample=0.4,
        url="ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1000_genomes_project/data/TSI/NA20778/alignment/NA20778.alt_bwamem_GRCh38DH.20150718.TSI.low_coverage.cram",
    conda:
        "../environment.yaml"
    shell:
        """
        samtools view --cram --subsample-seed {params.seed} --subsample {params.subsample} {params.url} chr{wildcards.chrom} > {output.cram}
